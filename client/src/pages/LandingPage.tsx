    ...
    <div className="min-h-screen bg-background text-primary font-mono relative overflow-hidden">
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-1 sm:gap-2 mb-6">
            ...
            <h1 className="text-xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-normal sm:tracking-wide md:tracking-widest break-words">
              FIRST_THINGS_FIRST
            </h1>
          </div>
          ...
          <p className="text-sm md:text-base mb-2 opacity-70 max-w-2xl mx-auto">A terminal-inspired task management system designed to help you focus on what truly matters. No distractions. No overwhelm.</p>
      ...
      <section className="relative z-10 py-24 px-4 border-t-4 border-primary">
        <div className="max-w-4xl mx-auto">
          <div className="border-4 border-primary p-8 md:p-12 bg-card/50 relative">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 text-center break-words">
              &gt;&gt; THE_PROBLEM &lt;&lt;
            </h2>
      ...
      <section id="features" className="relative z-10 py-24 px-4 border-t-4 border-primary">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-xl sm:text-3xl md:text-4xl font-bold mb-16 text-center break-words">
            &gt;&gt; CORE_FEATURES &lt;&lt;
          </h2>
      ...
      <section className="relative z-10 py-24 px-4 border-t-4 border-primary">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-lg sm:text-3xl md:text-4xl font-bold mb-8 break-words">
      ...
      <section className="relative z-10 py-24 px-4 border-t-4 border-primary">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-xl sm:text-3xl md:text-4xl font-bold mb-8 break-words">
            &gt;&gt; THE_PHILOSOPHY &lt;&lt;
          </h2>
      ...
      <section className="relative z-10 py-24 px-4 border-t-4 border-primary">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-6 break-words">
            READY_TO_FOCUS?
          </h2>
